...
class ConfigV2 (
    ...
    var aiGeneratedContentLabelEnabled: Boolean? = null
) : Parcelable
...
data class Messages (
    ...
    @SerialName("generated.by.ai.disclaimer")
    val generatedByAiDisclaimer: String = "Generated by AI"
) : Parcelable
...
data class Settings (
    ...
    /// Whether to display the "Generated by AI" label on responses with payload style "generated".
    /// Default false.
    val aiGeneratedContentLabelEnabled: Boolean? = null
) : Parcelable
    ...
    return ConfigV3(
        ...
        chatPanel = ChatPanel(
            ...
            settings = Settings(
                ...
                aiGeneratedContentLabelEnabled = configV2.aiGeneratedContentLabelEnabled,
            )
        )
    )
}
